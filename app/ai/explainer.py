...
FACTOR_LABELS = {
    ...
    "closes_in_upper_zone": "近阶段上沿强势区收盘数",
    "resistance": "阻力位",
    ...
    "breakdown_close_in_range": "跌破日收盘位置",
    "reclaim_body_pct": "确认日实体涨幅",
    "reclaim_rebound_from_low_pct": "确认日距回踩低点反弹幅度",
    "reclaim_above_break_open": "确认日是否收回跌破日开盘价",
    "rebound_from_low_pct": "收回日距低点反弹幅度",
    "no_new_low_after_reclaim": "收回后是否未再创新低",
    "confirm_close_vs_ma10": "确认日收盘/MA10",
    "confirm_close_vs_ma20": "确认日收盘/MA20",
    "ma20_flat_enough": "MA20是否走平",
